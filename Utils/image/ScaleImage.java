package cn.itcast.testmanager.common.util.image;
...
public class ScaleImage {
	...
	// try {
	// is.saveImageAsFormateJpg("D:\\tmp\\pic\\Desert.jpg",
	// "D:\\tmp\\pic\\Desert2.jpg", 100,
	// 100,"jpg");
	// long end = System.currentTimeMillis();
	// System.out.println(""+(end-start)/(double)1000+"秒");
	// } catch (Exception e) {
	 ...
	 *            保存文件高度px
	 * @param formatName
	 *            保存文件格式 JPEG、TIFF、RAW、BMP、GIF、PNG
	 * @throws Exception
	 */
	public void saveImageAsFormateJpg(String fromFileStr, String saveToFileStr,
			int formatWideth, int formatHeight, String formatName)
			throws Exception {
